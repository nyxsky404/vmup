    ...
    <Popover>
      <PopoverTrigger
        className={cn(
          ...
          'gap-2 max-lg:min-h-11 max-lg:px-3 data-[popup-open]:bg-fd-accent data-[popup-open]:text-fd-accent-foreground',
          className,
        )}
      >
        {children ?? 'Open'}
      ...
      <PopoverContent className="flex flex-col">
        {items.map((item) => (
          <a
            ...
            target="_blank"
            className="inline-flex items-center gap-2 rounded-lg p-2 max-lg:min-h-11 max-lg:p-2.5 text-sm hover:bg-fd-accent hover:text-fd-accent-foreground [&_svg]:size-4"
          >
            {item.icon}
            {item.title}
