---
title: Changelog
description: Notable changes in each vmup release, from 0.1.0 through the current npm version.
icon: ScrollText
---
...
- Docs site is [vmup.vercel.app](https://vmup.vercel.app). The npm package homepage and README point there.
