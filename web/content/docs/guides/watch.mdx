...
description: Watch a folder for files added after start, press Enter to upload one SSH batch, and paste the remote folder path into the coding agent.
icon: FolderOpen
---
...
Screenshots landing in a folder: [Upload screenshots to a remote coding agent](/docs/guides/screenshots-to-agent).
