---
title: Upload files
description: Pass paths, drop a directory, or use the native picker. Every mode uploads over SSH into one remote folder and leaves a clipboard path for the agent.
icon: Upload
---
